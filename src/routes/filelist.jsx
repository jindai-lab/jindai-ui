import {
  ...
  EditOutlined, SearchOutlined, LeftOutlined, ReloadOutlined,
  UploadOutlined
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <Space size="small">
          <Button icon={<LeftOutlined />} size="small" onClick={handleGoBack} disabled={folderPath === '' || folderPath === '/'}>返回</Button>
      ...
      >
        <Input placeholder="请输入新名称" value={folderName} onChange={(e) => setFolderName(e.target.value)} />
      </Modal>
      {/* 功能操作区：搜索 + 新增按钮组 */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <Input
        ...
        <Space size="small">
          ...
          ><Button icon={<UploadOutlined />} size="middle" onClick={() => handleAdd(false)}>上传文件</Button></Upload>
        </Space>
      </div>
